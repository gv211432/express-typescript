...
(function () {
  ...
  ImagePicker = (function () {
    ...
    ImagePicker.prototype.recursively_parse_option_groups = function (
      scoped_dom,
      target_container
    ) {
      ...
      for (j = 0, len = ref.length; j < len; j++) {
        ...
        container.append(
          jQuery(
            "<li class='group_title'>" + option_group.attr("label") + "</li>"
          )
        );
    ...
    ImagePicker.prototype.toggle = function (
      imagepicker_option,
      original_event
    ) {
  ...
  ImagePickerOption = (function () {
    ...
    ImagePickerOption.prototype.create_node = function () {
      var image, imgAlt, imgClass, thumbnail, imgId;
      this.node = jQuery("<li/>");
      ...
      imgId = this.option.data("img-id");
      if (imgId) {
        image.attr("id", imgAlt);
      }
